/// from https://gist.github.com/chrisvfritz/5f0a639590d6e648933416f90ba7ae4e
// format函数做了改造
var currencyValidator = {
  format: function (number) {
    return (Math.trunc(number * 10000) / 10000).toFixed(2)
  },
  ...
  parse: function (newString, oldNumber) {
    ...
    var NotAValidDollarAmountWarning = function (value) {
      return new CurrencyWarning(newString + ' is not a valid currency amount', value)
    }
